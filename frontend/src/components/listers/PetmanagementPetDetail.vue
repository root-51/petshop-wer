<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="Energy" v-model="item.energy" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Appearance" v-model="item.appearance" :editMode="editMode" @change="change" />
            </div>
            ...
            <PetStatus offline label="PetStatus" v-model="item.petStatus" :editMode="false" :key="false" @change="change" />
            <IllnessHistoryManager offline label="IllnessHistories" v-model="item.illnessHistories" :editMode="false" @change="change" />
        </v-card-text>
